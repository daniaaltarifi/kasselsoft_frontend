      ...
      const fetchAllData = async () => {
          ...
          try {
              ...
              await Promise.all([
                  ...
                  axios.get(`${API_URL}/aboutServices/getaboutServicesByLang/${lang}`),
        ...
        <p className="prag mt-4">
         ...
         {aboutData ? (
                  <>
                    ...
                    <p>
                      <span className="icon-check"><i className="bi bi-check"></i></span> {aboutData.point1}
                    </p>
                    <p>
                      <span className="icon-check"><i className="bi bi-check"></i></span> {aboutData.point2}
                    </p>
                    <p>
                      <span className="icon-check"><i className="bi bi-check"></i></span> {aboutData.point3}
                    </p>
                  </>
                ) : (
                  <p>Loading content...</p>
...
<section className="services team" id="team">
    ...
    <div className="main-txt main-txt-titel">
          ...
          <h3>{title1.title|| "Loading..."}</h3> {/* Adjust according to your data */}
          <h1>{title1.subtitle || "Loading..."}</h1> {/* Adjust according to your data */}
          <p className="prag mt-4">
          {title1.description|| "Loading..."}
      </p>
  ...
  <section className="services" id="service">
    <div className="container">
      ...
      <h3>{title2.title|| "Loading..."}</h3> {/* Adjust according to your data */}
          <h1>{title2.subtitle || "Loading..."}</h1> {/* Adjust according to your data */}
          <p className="prag mt-4">
          {title2.description|| "Loading..."}
      </p>
