        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-4 col-md-12 col-sm-12">
              ...
              <button type="button" className="btn btn_blogs">Facebook</button>
              <button type="button" className="btn btn_blogs">Algorithm</button>
              <button type="button" className="btn btn_blogs">Bangla</button>
              <button type="button" className="btn btn_blogs">Mirgbai</button>
              <button type="button" className="btn btn_blogs">Algorithm</button>
              <button type="button" className="btn btn_blogs">Facebook</button>
              <button type="button" className="btn btn_blogs">Mirgbai</button>
              <button type="button" className="btn btn_blogs">Bangla</button>
